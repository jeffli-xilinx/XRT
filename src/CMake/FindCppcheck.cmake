...
if(CPPCHECK_BIN)
    ...
    # Don't fail cmake on cppcheck errors
    set(CPPCHECK_ERROR_EXITCODE_ARG "--error-exitcode=0" CACHE STRING "The exitcode to use if an error is found")
    set(CPPCHECK_CHECKS_ARGS " --inconclusive --report-progress --enable=all" CACHE STRING "Arguments for the checks to run")
...
if(CPPCHECK_FOUND)
    ...
    message("cppcheck found. Running cppccheck-analysis by default")
else()
